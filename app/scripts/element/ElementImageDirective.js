  ...
  .directive('elementImage', ["context", "layerService", function(context, layerService) {
      return {
        ...
        controller: function($scope, $element) {
            ...
            $scope.layer.size.width = $scope.dataDrag.size.width;
            $scope.layer.size.height = $scope.dataDrag.size.width;
            
            $scope.elem = elem.image("http://127.0.0.1:3000/files/" + $scope.dataDrag.name, 10, 10, 1, 1);
